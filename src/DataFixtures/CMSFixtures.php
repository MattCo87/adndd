...
class CMSFixtures extends Fixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $cms1->setContent('1It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that   ');
        $cms1->setType("text");
        ...
        $cms2->setContent('2It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that   ');
        $cms2->setType("text");
        ...
        $cms3->setContent('3It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that   ');
        $cms3->setType("text");
