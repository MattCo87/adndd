 ...
 */
<<<<<<< HEAD:migrations/Version20210622153003.php
final class Version20210622153003 extends AbstractMigration
=======
final class Version20210624132202 extends AbstractMigration
>>>>>>> develop:migrations/Version20210624132202.php
{
...
<<<<<<< HEAD:migrations/Version20210622153003.php
        $this->addSql('CREATE TABLE scenario (id INT AUTO_INCREMENT NOT NULL, dungeonmaster_id INT NOT NULL, campaign_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, room_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, start_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL, private TINYINT(1) NOT NULL, INDEX IDX_3E45C8D8499F6A47 (dungeonmaster_id), INDEX IDX_3E45C8D8F639F774 (campaign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
=======
